...
app.get('/rest/u2f/register', u2f.registerRequest())
app.post('/rest/u2f/register', u2f.register())
app.get('/rest/u2f/sign', u2f.signRequest())
app.post('/rest/u2f/sign', u2f.sign())
